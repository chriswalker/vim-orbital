" Orbital - An intergalactically friendly color scheme for lightline
" Author: Chris Walker
" License: MIT
...
if(exists("g:lightline"))
    ...
    let s:p.normal.right = [ [ s:gray5, s:gray3 ], [ s:gray5, s:gray3 ] ]
    ...
    let s:p.insert.right = [ [ s:gray5, s:gray3 ], [ s:gray5, s:gray3 ] ]

    let s:p.replace.left = [ [ s:gray2, s:red ], [ s:gray5, s:gray3 ] ]
    let s:p.replace.right = [ [ s:gray5, s:gray3 ], [ s:gray5, s:gray3 ] ]

    let s:p.visual.left = [ [ s:gray2, s:orange ], [ s:gray5, s:gray3 ] ]
    let s:p.visual.right = [ [ s:gray5, s:gray3 ], [ s:gray5, s:gray3 ] ]
...
hh
    ...
    let g:lightline#colorscheme#orbital#palette = lightline#colorscheme#fill(s:p)
endif
