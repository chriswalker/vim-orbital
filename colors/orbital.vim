" Orbital - We're not in Deep Space just yet...
" Author: Chris Walker
" License: MIT
...
set background=dark
let g:colors_name = 'orbital'

let g:deepspace_italics = get(g:, 'orbital_italics', 0)
...
call s:HL('CursorLineNr',                   s:orange,    s:gray2,    'none')
...
"call s:HL('Statement',                      s:blue,     '',         'italic')
call s:HL('Statement',                      s:gray5,     '',         'italic')
